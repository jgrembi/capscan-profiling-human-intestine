...
a_img <- image_read(paste0(fig_dir_main_subpanels, "Fig_1a_subpanel_gi_overview.png"))
...
b_img <- image_read(paste0(fig_dir_main_subpanels, "Fig_1b_subpanel_study_overview.png"))
...
ggsave(paste0(fig_dir_main_subpanels, 'Fig_1c_subpanel_asv_family_level_barplots.pdf'), plot = c, width=12, height=5)
...
ggsave(filename = paste0(fig_dir_main_subpanels, "Fig_1d_subpanel_capsule_pH.pdf"), plot = d, height = 6, width = 6)
...
ggsave(filename = paste0(fig_dir_main_subpanels, "Fig_1e_subpanel_pcoa_canberra.pdf"), plot = e, height = 6, width = 8)
...
ggsave(paste0(fig_dir_main_subpanels, "Fig_1f_subpanel_diff_abundance.pdf"), plot = f, height = 5.8)
